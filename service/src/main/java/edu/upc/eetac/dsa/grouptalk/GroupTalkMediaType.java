...
public class GroupTalkMediaType {
    ...
    public final static String GROUPTALK_COMMENT = "application/vnd.dsa.grouptalk.group.comment+json";
    public final static String GROUPTALK_COMMENT_COLLECTION = "application/vnd.dsa.grouptalk.group.comment.collection+json";
