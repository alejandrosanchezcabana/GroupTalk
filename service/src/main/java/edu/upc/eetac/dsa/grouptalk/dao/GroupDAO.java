...
public interface GroupDAO {
    public Groups createGroup(String userid, String subject, String content) throws SQLException;
    public Groups getGroupById(String id) throws SQLException;
    public GroupsCollection getGroups() throws SQLException;
    public Groups updateGroup(String id, String subject, String content) throws SQLException;
